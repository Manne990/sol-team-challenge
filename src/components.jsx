...
const stateContent = {
  ...
  empty: [
    "No records yet",
    "Create the first record to begin building this view.",
  ],
  ...
  conflict: [
    "This record changed",
    "Review the latest version before saving your changes again.",
  ],
};
...
export function ToastRegion({ messages = [], onDismiss }) {
  return (
    ...
    >
      {messages.map((item) => (
        <div className={`toast toast--${item.tone || "success"}`} key={item.id}>
